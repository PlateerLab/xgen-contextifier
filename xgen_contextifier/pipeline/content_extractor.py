# xgen_contextifier/pipeline/content_extractor.py
"""
...
from xgen_contextifier.errors import ExtractionError
...
class BaseContentExtractor(ABC):
    ...
    def __init__(
        ...
        self._logger = logging.getLogger(
            f"xgen_contextifier.extractor.{self.__class__.__name__}"
        )
