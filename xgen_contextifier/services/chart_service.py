# xgen_contextifier/services/chart_service.py
"""
...
from xgen_contextifier.config import ProcessingConfig, ChartConfig
from xgen_contextifier.types import ChartData
...
class ChartService:
    ...
    def __init__(
        ...
        *,
        ...
        self._logger = logging.getLogger("xgen_contextifier.services.chart")
