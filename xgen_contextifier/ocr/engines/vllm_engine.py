# xgen_contextifier/ocr/engines/vllm_engine.py
...
from xgen_contextifier.ocr.base import BaseOCREngine, SIMPLE_OCR_PROMPT

logger = logging.getLogger("xgen_contextifier.ocr.vllm")
