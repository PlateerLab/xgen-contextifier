...
from xgen_contextifier.handlers.pptx._constants import ElementType, SlideElement
from xgen_contextifier.handlers.pptx._bullet import extract_text_with_bullets
from xgen_contextifier.handlers.pptx._table import (
    is_simple_table,
    extract_simple_text,
    extract_table,
)
