# xgen_contextifier/handlers/pdf_plus/_text_extractor.py
"""
...
from xgen_contextifier.handlers.pdf_plus._utils import (
    is_inside_any_bbox,
)
from xgen_contextifier.handlers.pdf_plus._text_quality_analyzer import (
