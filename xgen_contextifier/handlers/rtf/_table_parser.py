# xgen_contextifier/handlers/rtf/_table_parser.py
"""
...
from xgen_contextifier.types import TableCell, TableData
...
_logger = logging.getLogger("xgen_contextifier.rtf.table")
