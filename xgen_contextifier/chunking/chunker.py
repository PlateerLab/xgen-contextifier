# xgen_contextifier/chunking/chunker.py
"""
...
from xgen_contextifier.errors import ChunkingError
...
class TextChunker:
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._config = config
        self._logger = logging.getLogger("xgen_contextifier.chunking")
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if include_meta and result and not isinstance(result[0], str):
                from xgen_contextifier.chunking.metadata_enricher import (
