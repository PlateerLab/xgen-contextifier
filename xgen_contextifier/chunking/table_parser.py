# xgen_contextifier/chunking/table_parser.py
"""
...
Migrated from old xgen_contextifier.chunking.table_parser with:
- Unified API surface
...
logger = logging.getLogger("xgen_contextifier.chunking.table_parser")
