# xgen_contextifier/chunking/table_chunker.py
"""
...
Migrated from old xgen_contextifier.chunking.table_chunker with:
...
from xgen_contextifier.chunking.table_parser import (
    parse_html_table,
    has_complex_spans,
...
logger = logging.getLogger("xgen_contextifier.chunking.table_chunker")
