# xgen_contextifier/chunking/strategies/protected_strategy.py
"""
...
from xgen_contextifier.chunking.constants import (
    HTML_TABLE_PATTERN,
    MARKDOWN_TABLE_PATTERN,
    TEXTBOX_BLOCK_PATTERN,
)
from xgen_contextifier.chunking.table_chunker import chunk_large_table
from xgen_contextifier.chunking.table_parser import is_markdown_table
from xgen_contextifier.chunking.strategies.base import BaseChunkingStrategy

logger = logging.getLogger("xgen_contextifier.chunking.protected_strategy")
