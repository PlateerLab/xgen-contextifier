# xgen_contextifier/chunking/strategies/page_strategy.py
"""
...
logger = logging.getLogger("xgen_contextifier.chunking.page_strategy")
    ...
    def chunk(
        ...
        **context: Any,
        ...
        if not pages:
            ...
            from xgen_contextifier.chunking.strategies.plain_strategy import (
